    ...
    <div style={{ position: 'relative' }}>
      ...
      {isOpen && (
        <>
          ...
          <div style={{ position: 'absolute', top: 'calc(100% + 8px)', right: 0, width: '320px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '16px', boxShadow: '0 10px 40px rgba(0,0,0,0.5)', zIndex: 100, overflow: 'hidden' }}>
