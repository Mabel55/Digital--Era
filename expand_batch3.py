"""
Batch 3: Expand more courses with 3 new lessons each.
"""
import json
...
def inject_lessons(filepath, new_lessons):
    ...
    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(content)
    print(f'\n=== Batch 3 TOTAL: {injected} new lessons ===')
